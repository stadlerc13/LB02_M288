...
const renderTasks = (tasks, filters) => {
    const filteredTasks = tasks.filter((task) => {
        ...
        const showBoughtMatch = filters.hideCompleted || task.completed;
        const tobuyMatch = !filters.hideCompleted && !task.completed;
        ...
        //return searchTextMatch && showBoughtMatch;
        //return searchTextMatch && tobuyMatch;
